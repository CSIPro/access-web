...
export const UserFailedAttempts = () => {
  ...
  return (
    <div className="flex w-full flex-col items-start gap-4 rounded-lg bg-secondary p-4 text-white md:col-span-2">
      <span className="text-7xl">{logs?.length || 0}</span>
      <span className="text-lg">your failed attempts</span>
    </div>
  );
};
